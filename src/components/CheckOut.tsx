...
const CheckOut = () => {
  ...
  return (
    <><Header /><div className="container mx-auto py-12 pl-4 pr-4 lg:pl-16 lg:pr-16 xl:pl-40 xl:pr-40">
      <div className="flex items-center space-x-2 text-gray-500 text-[14px] mb-8">
        ...
        <a href="#" onClick={handleClick6} className="hover:underline">Cart</a>
        <img src="/R2S-Client/CrossLine.svg" alt="CrossLine" className="w-[7px]" />
        <span className="font-normal text-black">CheckOut</span>
      </div>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">

        <div className="sm:grid grid-cols-2 gap-10 lg:ml-12 ml-4 mr-4 xl:ml-16">
          <div>
